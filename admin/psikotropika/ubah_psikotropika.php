...
<form method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<a href="index.php?halaman=psikotropika" class="btn btn-success"><i class="fa fa-chevron-left"> Batal</i></a>
	</div>
</form>
...
<?php 
	...
	if (isset($_POST["ubah"]))
	{
		...
		$isi = htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($_POST['isi'])));
			...
			$koneksi->query("UPDATE psikotropika SET judul='$judul', 
																						gambar='$namafoto', 
																						isi='$isi' 
															WHERE id_psikotropika='$_GET[id]'");
		}
		else 
		{
			$judul = stripslashes(htmlspecialchars($_POST['judul']));
		...
		echo "<div class='alert alert-info'>Data psikotropika telah diubah</div>";
