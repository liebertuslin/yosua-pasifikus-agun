...
<?php 
	...
	if (isset($_POST["ubah"]))
	{
		...
		if(!empty($lokasifoto))
		{
			...
			$koneksi->query("UPDATE narkotika SET judul='$judul', gambar='$namafoto', isi='$isi' WHERE id_narkotika='$_GET[id]'");
		}
		else 
		{
			$judul = stripslashes(htmlspecialchars($_POST['judul']));
			...
			$koneksi->query("UPDATE narkotika SET judul='$judul',isi='$isi' WHERE id_narkotika='$_GET[id]'");
		}
