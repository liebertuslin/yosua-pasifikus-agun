<?php 
  ...
  $id_narkotika = $_GET["id"];
  $ambil = $koneksi->query("SELECT * FROM narkotika WHERE id_narkotika='$id_narkotika'");
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <div class="dropdown show">
            <li><a class="nav-link" style="color: white;" href="../narkotika.php">Narkotika</a></li>
          </div>
          <li class="nav-item">
    ...
    <div class="row pt-5">
      <div class="col-sm-12 col-md-6 col-lg-8 mb-5">
        <div class="artikel pb-5">
          ...
          <a href="../narkotika.php" class="btn btn-outline-default p-0">Back to posts</a>
        </div>
        <!-- <a href="../golongan/narkotika.php" class="btn btn-outline-default p-0 text-dark"> > Baca juga artikel terkait golongan narkotika</a> -->
      </div>
        ...
        <div class="card mb-3">
          <div class="card-body p-3">
            ...
            <div class="card-labels mb-5">
              <?php $ambil = $koneksi->query("SELECT * FROM narkotika WHERE judul=judul") ?>
              <?php while( $singlePage = $ambil->fetch_assoc()) { ?>
              <ul style="margin: 0; padding: 0">
                <li style="list-style: none; margin-bottom: .5rem">
                  <a class="text-dark" href="../single page/read-narkotika.php?id=<?php echo $singlePage['id_narkotika']; ?>"><?php echo $singlePage["judul"]; ?></a>
                  </li>
              </ul>
              <?php } ?>
            </div>
