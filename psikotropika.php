...
<head>
  <meta charset="UTF-8">
  <title>Halaman Posts Psikotropika</title>
        ...
        <div class="card pb-3">
          ...
          <?php 
            ...
            if (isset($_GET['cari'])) {
              ...
              $ambil = $koneksi->query("SELECT * FROM psikotropika WHERE judul LIKE '%".$cari."%'");
            } else {
              $ambil = $koneksi->query("SELECT * FROM psikotropika");
            }
          ?>
          ...
          <div class="card-body">
            ...
            <a href="single page/read-psikotropika.php?id=<?php echo $pecah["id_psikotropika"]; ?>"
      ...
      <div class="col-md-4">
        <article class="artikel-website">
          <div class="container artikel">
            ...
            <form method="get" action="psikotropika.php">
